          ...
          <View style={styles.signInView}>
            ...
            <View style={styles.inputsView}>
              ...
              <Input
                ...
                icon={
                  <AntDesign name="user" size={24} color={Colors.MAIN_COLOR} />
                }
                border={1}
              ...
              {error ? (
                <Text style={{ color: Colors.FAILED_COLOR }}>
                  {i18n.t(error)}
                </Text>
              ) : null}
              ...
              <Button
                ...
                pressHandler={signinHanlder}
              />
            </View>
            <NavigateBetweenSign
              isSignIn={true}
              pressHandler={goToSignUpHandler}
            />
          </View>

          {showForgetPasswordModal && (
            <ForgetPasswordModal
              cancelAction={() => setShowForgetPasswordModal(false)}
            />
          )}
        </>
      )}
