  ...
  return (
    ...
    >
      <View style={styles.modalView}>
        <ScrollView>
          <Text style={[styles.header]}>تعهد الخصوصية لشركة سمارت فارما الطبية</Text>
          <Text style={[styles.textJustify]}>
            شركة سمارت فارما التضامنية ملتزمة بحماية خصوصية بيانات كل مستخدمي موقعنا على الانترنت أو تطبيق الهاتف
            المحمول الخاص بنا. يرجى قراءة سياسة الخصوصية التالية و التي توضح كيف نستعمل ونحمي معلوماتك. سنكون المتحكمين
          ...
          <View>
            <View style={styles.marginTop}>
              <Text style={styles.textJustify}>
                ...
                على الرقم: 0943063066 أو عن طريق الايميلsmartpharma.sy@gmail.com
              </Text>
            </View>
            ...
            <View style={styles.marginTop}>
              <Text style={[styles.textJustify]}>
                ...
                مكتب امن المعلومات باستخدام التفاصيل التالية: رقم الهاتف: 0943063066 عنوان البريد الالكتروني:
